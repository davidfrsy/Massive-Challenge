...
const Operasional = () => {
    ...
    const [form, setForm] = useState({ id: '', tanggal: '', pemeliharaan: '', bibit: '', pakan: '', suplemen: '', lainnya: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setForm({ id: '', tanggal: '', pemeliharaan: '', bibit: '', pakan: '', suplemen: '', lainnya: '' });
                        ...
                        <dialog id="my_modal_1" className="modal">
                            <div className="modal-box">
                                <div className='flex flex-col justify-center'>
                                    ...
                                    <h3 className="font-bold text-lg text-center">{isUpdateMode ? 'Update' : 'Tambah'} Data Operasional!</h3>
                                </div>
                                <div className='flex flex-col justify-center p-8 text-left'>
                                    <form onSubmit={handleSubmit} className='p-2 text-justify'>
                                        ...
                                        <div className='p-1 space-x-5 '>
                                            <label htmlFor="bibit" className='font-bold text-lg'>Bibit</label>
                                            <input type="text" name="bibit" value={form.bibit} onChange={handleChange} className='border border-gray-400 rounded w-56 float-right px-1' />
                                        </div>
                                        <div className='p-1 space-x-5 '>
                                            <label htmlFor="pakan" className='font-bold text-lg'>Pakan</label>
                                            <input type="text" name="pakan" value={form.pakan} onChange={handleChange} className='border border-gray-400 rounded w-56 float-right px-1' />
                                        </div>
                                        <div className='p-1 space-x-5 '>
                                            <label htmlFor="suplemen" className='font-bold text-lg'>Suplemen</label>
                                            <input type="text" name="suplemen" value={form.suplemen} onChange={handleChange} className='border border-gray-400 rounded w-56 float-right px-1' />
                                        </div>
                                        <div className='p-1 space-x-5 '>
                                            <label htmlFor="lainnya" className='font-bold text-lg'>Lainnya</label>
                                            <input type="text" name="lainnya" value={form.lainnya} onChange={handleChange} className='border border-gray-400 rounded w-56 float-right px-1' />
                                        </div>
