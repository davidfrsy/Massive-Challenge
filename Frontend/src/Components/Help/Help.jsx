                ...
                <form className='max-w-sm mx-auto'>
                    <div className='px-5 text-2xl'>
                        <div className='flex py-6'>
                            <div className='pr-5'>
                                <ul>
                                    <li><label htmlFor="" className='text-gray-400'>Nama</label></li>
                                    <li><input type="text" name="nama" id="" className='bg-gray-100 w-52 focus:outline-none text-gray-700 border-b-2 border-gray-400'/></li>
                                </ul>
                            </div>
                            <div className='pl-6'>
                            <ul>
                                <li><label htmlFor="" className='text-gray-400'>Email</label></li>
                                <li><input type="email" name="email" id="" className='bg-gray-100 w-52 focus:outline-none text-gray-700 border-b-2 border-gray-400'/></li>
                            </ul>
                            </div>
                        </div>
                        <div className='py-6'>
                            <ul>
                                <li className='pb-14'><label htmlFor="" className='text-gray-400'>Pesan</label></li>
                                <li><input type="text" name="" id="" className='bg-gray-100 w-cust4 focus:outline-none text-gray-700 border-b-2 border-gray-400'/></li>
                            </ul>
                        </div>
                        <div className='py-6'>
