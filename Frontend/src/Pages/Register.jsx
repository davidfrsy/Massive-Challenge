            ...
            <div className='relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0'>
                <div className='flex flex-col justify-center p-8 md:p-14 max-w-sm'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='py-4'>
                            <label htmlFor='username' className='mb-2 text-md'>Name</label>
                            <input
                                type="text"
                                value={values.name}
                ...
                <div className='relative'>
                    <img src={bg_login} alt="Background Login" className='w-[400px] h-full hidden rounded-r-2xl md:block object-cover' />
